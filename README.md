...
#### **Rigueur, Résilience et Patience**
...
J'ai également souvent eu un role pédagogique, que ce soit avec ma famille ou avec des collègues, pour leur expliquer telle ou telle chose, ce qui m'a demandé de la patience et de la résilience.
...
##### ***Java / JavaFX***
Pendant ma première année de BUT, j’ai développé lors du second semestre un jeu adapté d’un jeu de plateau appelé [Latice](https://github.com/Dolchate/Latice.git). Ce projet m’a permis de comprendre le développement orienté objet appliqué avec des langages comme Java et JavaFX. En effet, le jeu que j’avais créé lors de mes années au lycée a été développé avec python sans utiliser de classes.
##### ***Node.js / JS***
